                ...
                <div class="row">
                    {{-- <div class="col-sm-12">
                        ...
                        <div class="form-floating form-floating-outline">
                            <select id="ref_populate_id" name="ref_populate_id" class="form-control">
                                <option value="">--</option>
                            </select>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function renderContent(data) {
                ...
                Object.values(data).forEach((user) => {
                    var button =
                        ...
                        '</ul>' +
                        '</div>' +
                        `<a target="_blank" href="<?= url('populate/') ?>/${user['id']}" title="Lihat Detail" class="btn btn-sm btn-text-secondary rounded-pill btn-icon item-edit"><i class="mdi mdi-eye-outline" ></i></a>`;
                    var btnFile =
                        `<a target="_blank" href="<?= url('storage/upload/populate/') ?>/${user['filename']}" title="Lihat Detail" class="btn btn-sm btn-text-secondary rounded-pill btn-icon ">Lihat file</a>`;
            ...
            ContentForm.insertBtn.on('click', () => {
                ...
                submit_form('{{ route('populate.create') }}', 'POST');
            });
            ContentForm.updateBtn.on('click', () => {
                event.preventDefault();
                submit_form('{{ route('populate.update') }}', 'POST');
            });
