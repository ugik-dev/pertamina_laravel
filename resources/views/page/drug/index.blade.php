    ...
    <div class="offcanvas offcanvas-end" id="add-new-record" style="width : 700px !important">
        ...
        <div class="offcanvas-body flex-grow-1">
            <form class="add-new-record pt-0 row g-3" id="form-field" onsubmit="return false">
                ...
                <div class="col-sm-12">
                    <label for="basicFullname">Satuan :</label>
                    <div class="input-group input-group-merge">
                        <span class="input-group-text"><i class="mdi mdi-file"></i></span>
                        <input type="text" id="satuan" class="form-control dt-full-name" name="satuan" />
                    </div>
                </div>
                <div class="col-sm-12">
            ...
            function renderField(data) {
                ...
                Object.values(data).forEach((user) => {
                    var button =
                        ...
                        '</ul>' +
                        '</div>';
                    renderData.push([user['id'], button, user['name'], user['satuan'],
