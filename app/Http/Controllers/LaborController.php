...
class LaborController extends Controller
{
...

    {
        ...
        return view('page.labor.index', compact('request', 'dataContent'));
    }
...

    {
        ...
        return view('page.labor.sebaran', compact('request', 'dataContent'));
    }
    ...
    public function create(Request $request)
    {
        try {
            ...
            $data = Labor::create($att);
            $data = Labor::find($data->id);
    ...
    {
        try {
            $data = Labor::findOrFail($request->id);
