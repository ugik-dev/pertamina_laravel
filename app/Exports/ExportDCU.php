...
class ExportDCU implements FromCollection,  WithStyles,  WithCustomStartCell, WithEvents, WithTitle, WithProperties
{
    protected $data;
    ...
    {
        return 'DCU REPORT ' . $this->filter['date_start'] . ' sd ' . $this->filter['date_end'];  // Nama sheet yang kamu inginkan
    }
